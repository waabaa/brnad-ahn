#!/usr/bin/env python3
"""Fetch official-site logos for batch-8 Korean brands using stored
...
DATA = elo.DATA_JSON
SLUGS = ["nepa","eider","gs-construction","dl-enc","hdc-hyundai","daewoo-enc","samsung-ct",
 "daewoong","dong-a-st","sk-biopharm","hugel","boryung","coway","cuckoo","sk-magic","winia",
 "cheongho-nais","sempio","crown-confectionery","spc-samlip","hy","sajo","neowiz",
 "lionheart-studio","nhn","zigbang"]
