#!/usr/bin/env python3
"""Fetch official-site logos for batch-7 Korean brands using stored
officialWebsite. Reuses enrich_logos_official functions. Visual verification
is done AFTER this runs."""
...
DATA = elo.DATA_JSON
SLUGS = ["clio","discovery-expedition","xexymix","stylenanda","national-geographic-apparel",
 "starbucks-korea","daiso","baskin-robbins-korea","gong-cha","ibk","samsung-securities",
 "kyobo-life","hyundai-marine","meritz-fire","kg-mobility","renault-korea","hl-mando",
 "nexen-tire","hanon-systems","hanwha-aerospace","kai","lig-nex1","korea-zinc","kcc"]
